...
export default function ImageToWordPage() {
 ...
 useEffect(() => {
        ...
        if (existingScript) {
          existingScript.addEventListener("load", () => {
            if (window.Tesseract) {
              ...
              reject(
                new Error(
                  "Tesseract loaded but was not found."
                )
              );
            }
          });
          ...
          existingScript.addEventListener("error", () => {
            reject(
              new Error("Could not load the OCR engine.")
            );
          });
  ...
  async function processSingleImage(id: string) {
    ...
    try {
      ...
      setStatus(`OCR completed for ${item.name}.`);
    } catch (error) {
      console.error(error);
  ...
  async function extractAllText() {
    ...
    try {
      ...
      setStatus("OCR completed for all images.");
    } catch (error) {
      console.error(error);
      ...
      <section className="mx-auto max-w-7xl px-5 py-10">
        <div className="mb-8">
          ...
          <p className="mt-3 max-w-2xl text-slate-600">
            ...
            extracted text, and create an editable Word
            document.
          </p>
        </div>
              ...
              <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
                ...
                <div className="flex flex-wrap gap-2">
                  ...
                  <button
                    ...
                    className="rounded-xl bg-[#0B1020] px-4 py-2.5 text-sm font-bold text-white transition hover:bg-slate-800 disabled:cursor-not-allowed disabled:opacity-50"
                  >
                    {isCreatingDoc
                      ? "Creating..."
                      : "Download Word"}
                  ...
                  <div className="p-5">
                    ...
                    <div className="mt-4 flex gap-2">
                      <button
                        ...
                        className="flex-1 rounded-xl border border-blue-200 bg-blue-50 px-3 py-2.5 text-sm font-bold text-blue-700 transition hover:bg-blue-100 disabled:opacity-50"
                      >
                        OCR This Image
                      </button>
                      ...
                      <button
                        ...
                        disabled={index === 0}
                        className="rounded-xl border border-slate-200 px-3 py-2.5 text-sm font-bold disabled:opacity-40"
                      >
                        ↑
                      </button>
